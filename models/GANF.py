...
#%%
import sys
sys.path.append("/root/zengzihui/ISST/GANF/models")
...
if __name__ == "__main__":
    ...
    n_hidden = 1
    batch_norm = False
    nf = MAF(n_blocks, input_size, hidden_size, n_hidden, cond_label_size=hidden_size, batch_norm=batch_norm,activation='tanh')
